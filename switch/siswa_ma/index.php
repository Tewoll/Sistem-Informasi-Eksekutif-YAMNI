		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active">Data Siswa MA</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<a href="index.php?page=siswa_ma&act=tambah" type="button" class="btn btn-primary">Tambah Data</a>
						...
						<div class="modal fade" id="modal-export" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form method="POST" class="form-horizontal" action="index.php?page=siswa_ma&act=proses&data=import" id="form1" enctype="multipart/form-data" name="import">
										<div class="modal-body">
											<div class="card-body">
												<div class="form-group">
													<label for="helperText">Data Excel<span class="text-danger">&nbsp;*</span></label>
													<input type="file" class="form-control" name="filesiswa_ma" required>
													<p><small class="text-muted"><i>Masukkan file excel yang akan diimport dengan format xls/xlsx.</i></small></p>
												</div>
												<a href="../sie/dist/file/Data Siswa MA.xls" download><u>Download Format Excel</u></a>
											</div>
										</div>
						...
						<div class="table-responsive">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php 
			                        $no = 1;
			                        $query = "SELECT id, nama_siswa, jenkel,tmpt_lahir, tgl_lahir, nama_ortu, id_tingkat, kelas, id_asal_tingkat_sekolah, nama_asal_sekolah, alamat, kota, status_ekonomi, id_tajaran FROM siswa WHERE id_tingkat = '1' ORDER BY kelas ASC";
			                        ...
			                        <tr>
			                        	...
			                        	<td>
			                        		...
			                        		<a class="btn btn-xs bg-warning" href="index.php?page=siswa_ma&act=edit&id=<?php echo $row['id']; ?>">
			                        			<i class="fas fa-edit" ></i> Edit</a>
			                        		<a class="btn btn-xs bg-danger" href="#" onClick="confirm_modal('index.php?page=siswa_ma&act=proses&data=hapus&id=<?php echo $row['id']; ?>');"><i class='fas fa-trash' title="Hapus" ></i> Hapus</i></a>
			                        	</td> 
