		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active">Tambah Data Siswa MA</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
...
<!-- /.content-header -->
<br>
<form method="POST" class="form-horizontal" action="index.php?page=siswa_ma&act=proses&data=tambah" id="form1" name="tambah">
						...
						<div class="card mb-4">
							...
							<div class="card-body">                 
								...
								<div class="form-group">
                                    ...
                                    <p><small class="text-muted"><i>Pilih jenis kelamin siswa yang akan ditambahkan.</i></small></p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <p><small class="text-muted"><i>Pilih kelas siswa yang akan ditambahkan.</i></small></p>
                                </div>
                                <div class="form-group">
