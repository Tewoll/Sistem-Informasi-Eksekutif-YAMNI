		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active">Data Guru MI</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
			...
			<div class="col-12">
				...
				<div class="card">
					<div class="card-header">
						<a href="index.php?page=guru_mi&act=tambah" type="button" class="btn btn-primary">Tambah Data</a>
						...
						<div class="modal fade" id="modal-export" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form method="POST" class="form-horizontal" action="index.php?page=guru_mi&act=proses&data=import" id="form1" enctype="multipart/form-data" name="import">
										<div class="modal-body">
											<div class="card-body">
												<div class="form-group">
													<label for="helperText">Data Excel<span class="text-danger">&nbsp;*</span></label>
													<input type="file" class="form-control" name="fileguru_mi" required>
													<p><small class="text-muted"><i>Masukkan file excel yang akan diimport dengan format xls/xlsx.</i></small></p>
												</div>
												<a href="../sie/dist/file/Data Guru MI.xls"  download><u>Download Format Excel</u></a>
											</div>
										</div>
								...
								<tbody>
			                        ...
			                        <tr>
			                        	...
			                        	<td>
			                        		...
			                        		<a class="btn btn-xs bg-warning" href="index.php?page=guru_mi&act=edit&id=<?php echo $row['id']; ?>" title="Edit Data Guru">
			                        			<i class="fas fa-edit" ></i> Edit</a>
			                        		<a class="btn btn-xs bg-danger" href="#" onClick="confirm_modal('index.php?page=guru_mi&act=proses&data=hapus&id=<?php echo $row['id']; ?>');"><i class='fas fa-trash' title="Hapus Data Guru" ></i> Hapus</i></a>
			                        	</td> 
									...
									<div class="modal fade" id="modal<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-footer justify-content-between">
													<a class="btn btn-default bg-warning" href="index.php?page=guru_mi&act=edit&id=<?php echo $row['id']; ?>" title="Edit Data Guru">
														<i class="fas fa-edit" ></i> Edit</a>
													<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
												</div>
											</div>
