...
if(empty($bgp)){
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Edit Data Guru MI</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<form method="POST" class="form-horizontal" action="index.php?page=guru_mi&act=proses&data=ubah" id="form1" method="post" name="ubah" enctype="multipart/form-data">
...
<?php }else{ echo '<meta http-equiv="refresh" content="0;url=index.php?page=guru_mi">'; } ?>
<?php } }?>