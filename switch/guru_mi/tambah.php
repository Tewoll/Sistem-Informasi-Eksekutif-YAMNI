		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item"><a href="index.php?page=guru_mi">Data Guru MI</a></li>
					<li class="breadcrumb-item active">Tambah Data Guru MI</li>
				</ol> 
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
...
<!-- /.content-header -->
<br>
<form method="POST" class="form-horizontal" action="index.php?page=guru_mi&act=proses&data=tambah" id="form1" name="tambah" enctype="multipart/form-data">
						...
						<div class="card mb-4">
							...
							<div class="card-body">                 
								...
								<div class="form-group">
                                    ...
                                    <p><small class="text-muted"><i>Masukkan jenis kelamin guru yang akan ditambahkan.</i></small></p>
                                </div>
                                <div class="form-group">
                                	<label for="helperText">Pendidikan Terakhir<span class="text-danger">&nbsp;*</span></label>
                                	<div class="input-group">
                                    	<select class="form-control select2bs4" name="pendidikan" tabindex="-1" required>
                                    		<option disabled selected> Pilih </option>
                                    		<?php
                                	...
                                	<p><small class="text-muted"><i>Masukkan pendidikan terakhir guru yang akan ditambahkan.</i></small></p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                	...
                                	<p><small class="text-muted"><i>Masukkan jabatan guru data yang akan ditambahkan.</i></small></p>
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4 select2-hidden-accessible" name="tingkat" tabindex="-1">
                                        <option value="3" selected="selected"> Madrasah Ibtidaiah (MI) </option>
                                    </select>
                                    <p><small class="text-muted"><i>Tingkatan sekolah guru yang akan ditambahkan.</i></small></p>
                                </div>
                                <div class="form-group">
					...
					<div class="modal fade" id="modal-kembali">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer justify-content-between">
									<button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Batal</button>
									<a href="index.php?page=guru_mi" class="btn btn-primary btn-sm float-md-right">Ya, Jangan simpan</a>
								</div>
							</div>
							<!-- /.modal-content -->
						</div>
