...
if(empty($bgp)){
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a href="index.php?page=siswa_mi">Data Siswa MI</a></li>
						<li class="breadcrumb-item active">Edit Data Siswa MI</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<form method="POST" class="form-horizontal" action="index.php?page=siswa_mi&act=proses&data=ubah" id="form1" method="post" name="ubah">
							...
							<div class="card mb-4">
								...
								<div class="card-body">                 
									...
									<div class="form-group">
										...
										<?php
											if ($e['kelas']=='I'){
												...
												<option value='IV'>IV (Empat)</option>
												<option value='V'>V (Lima)</option>
												<option value='VI' selected>VI (Enam)</option>";
											}else{
									...
									<div class="form-group">
										...
										<?php
											if ($e['id_asal_tingkat_sekolah']=='4'){
												echo " <option disabled>--Pilih--</option>
												<option value='4' selected>Taman Kanak-Kanak (TK)</option>
												<option value='5' >Tidak Ada</option>";
											}elseif ($e['id_asal_tingkat_sekolah']=='5'){
												echo " <option value='0' disabled>--Pilih--</option>
												<option value='4' >Taman Kanak-Kanak (TK)</option>
												<option value='5' selected>Tidak Ada</option>";
											}
											echo "</select>";?>
							...
							<div class="modal fade" id="modal-kembali">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-footer justify-content-between">
											<button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Batal</button>
											<a href="index.php?page=siswa_mi" class="btn btn-primary btn-sm float-md-right">Ya, Jangan simpan</a>
										</div>
									</div>
									<!-- /.modal-content -->
								</div>
...
<?php }else{ echo '<meta http-equiv="refresh" content="0;url=index.php?page=siswa_mi">'; } ?>
<?php } }?>