...
if(empty($bgp)){
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Edit Data Siswa MTs</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<form method="POST" class="form-horizontal" action="index.php?page=siswa_mts&act=proses&data=ubah" id="form1" method="post" name="ubah">
							...
							<div class="card mb-4">
								...
								<div class="card-body">                 
									...
									<div class="form-group">
										...
										<?php
											if ($e['kelas']=='VII'){
												...
												<option value='VII' selected> VII (Tujuh)</option>
												<option value='VIII'> VIII (Delapan)</option>
												<option value='IX'> IX (Sembilan)</option>";
											}elseif ($e['kelas']=='VIII'){
												echo " <option value='0' disabled>Pilih</option>
												<option value='VII'> VII (Tujuh)</option>
												<option value='VIII' selected> VIII (Delapan)</option>
												<option value='IX'> IX (Sembilan)</option>";
											}elseif ($e['kelas']=='IX'){
												echo " <option value='0' disabled>Pilih</option>
												<option value='VII'> VII (Tujuh)</option>
												<option value='VIII'> VIII (Delapan)</option>
												<option value='IX' selected> IX (Sembilan)</option>";
											}else{
									...
									<div class="form-group">
										...
										<?php
											if ($e['id_asal_tingkat_sekolah']=='6'){
												echo " <option disabled>--Pilih--</option>
												<option value='6' selected>Sekolah Dasar (SD)</option>
												<option value='2' >Madrasah Ibtidaiah (MI)</option>";
											}elseif ($e['id_asal_tingkat_sekolah']=='2'){
												echo " <option value='0' disabled>--Pilih--</option>
												<option value='6' >Sekolah Dasar (SD)</option>
												<option value='2' selected>Madrasah Ibtidaiah (MI)</option>";
											}
											echo "</select>";?>
...
<?php }else{ echo '<meta http-equiv="refresh" content="0;url=index.php?page=siswa_mts">'; } ?>
<?php } }?>